...
if __name__ == "__main__":
    ...
    print('Время работы сортировки пузырьком: ', timeBubble, 'сек')
    print('Время работы сортировки вставками: ', timeInsert, 'сек')
    print('Время работы сортировки выбором: ', timeSelect, 'сек')
